...
/**
 * A simple [Fragment] subclass. Use the [ContextFragment.newInstance] factory method to create an
...
class ContextFragment : Fragment() {
  ...
  override fun onCreateView(
    ...
    _binding = QuestionnaireContextBinding.inflate(inflater, container, false)
