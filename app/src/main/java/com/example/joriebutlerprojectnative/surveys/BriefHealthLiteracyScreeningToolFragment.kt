...
class BriefHealthLiteracyScreeningToolFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.questionnaire_brief_health_literacy_screening_tool,
            container,
            false
        )
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment BriefHealthLiteracyScreeningToolFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            BriefHealthLiteracyScreeningToolFragment().apply {
