...
class AcitivitiesOfDailyLifeScaleFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.questionnaire_acitivities_of_daily_life_scale,
            container,
            false
        )
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment AcitivitiesOfDailyLifeScaleFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AcitivitiesOfDailyLifeScaleFragment().apply {
